  ...
  return (
    ...
    >
        ...
        <div className="container h-full flex items-center justify-between">
          <div
            className={cn(
              ...
              isScrolled
                ? "opacity-0 scale-75 translate-x-[-100%]"
        ...
        >
          <nav className="container py-4 flex flex-col">
            ...
            >
              ...
              >
                <Button
                  className="w-full bg-[#2a5a2a] hover:bg-[#3a7a3a] text-white"
                  size="sm"
                >
                  Register Now
                </Button>
      ...
      <main>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                    <div className="p-3 text-white w-full">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs bg-[#2a5a2a] px-1.5 py-0.5 rounded">
                          {item.event}
                        </span>
                      </div>
                    </div>
          ...
          <div className="container relative z-10">
            ...
            <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
              {[
                ...
                >
                  <h3 className="text-lg font-bold mb-2 text-[#90ee90]">
                    {item.q}
                  </h3>
        ...
        <section
          id="sponsors"
          className="py-16 md:py-24 bg-[#0a2a0a]/50 relative"
        >
          <div className="absolute inset-0 bg-[url('/fern-pattern.svg')] opacity-5 pointer-events-none"></div>
          <div className="container relative z-10">
      ...
      <footer className="bg-[#0a1f0a] py-12 border-t border-[#2a5a2a]">
        <div className="container">
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <div>
              <h3 className="font-bold text-lg mb-4 text-[#90ee90]">
                Quick Links
              </h3>
          ...
          <div className="mt-12 pt-8 border-t border-[#2a5a2a] text-center text-sm text-[#a0d0a0]">
            <p>
              &copy; {new Date().getFullYear()} KiwiHacks. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
