  ...
  const socialPlatforms = [
    {
      ...
      description: "Join our Discord server to chat with other hackers, get event updates, and find teammates.",
      buttonText: "Join Discord Server",
      url: "https://discord.gg/596VN4SYVr",
      color: "#5865F2",
//      members: "10+",
    },
    {
...
//      followers: "15+",
    },
    {
      ...
      description: "Follow us on Linkedin for pre and post event updates and photos, as well as opportunities to connect with sponsors!",
          ...
          <div className="text-center mb-12">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-[#a0d0a0] max-w-2xl mx-auto mt-6">
                Join our community to stay updated and connect with fellow teenage hackers!
              </p>
            </div>
          </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[#d0ffd0] mt-1">
                      <a href="mailto:niko@kiwihacks.org" className="hover:text-[#90ee90] transition-colors">
                        niko@kiwihacks.org
                      </a>
                    </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-white">Location</h3>
                      <p className="text-[#d0ffd0] mt-1">
                        <a
                          href="https://maps.app.goo.gl/EVJ1Nx6nwHXrKoe98"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="hover:text-[#90ee90] transition-colors"
                        >
                          GridAKL / John Lysaght Startup Space
                        </a>
                      </p>
                  </div>
                </div>
